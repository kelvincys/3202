...
-- 資料庫： `moment`
--
CREATE DATABASE IF NOT EXISTS `moment` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;
USE `moment`;
...
--
ALTER TABLE `order_detail`
  ADD CONSTRAINT `order_detail_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`),
  ADD CONSTRAINT `order_detail_ibfk_2` FOREIGN KEY (`service_id`) REFERENCES `service` (`service_id`);

--
-- 資料表的 Constraints `user_detail`
--
ALTER TABLE `user_detail`
...
--
-- 資料表的匯出資料 `pma__table_info`
--

INSERT INTO `pma__table_info` (`db_name`, `table_name`, `display_field`) VALUES
('moment', 'user_detail', 'user_id');
...
('root', '2018-05-08 04:10:54', '{\"lang\":\"zh_TW\",\"Console\\/Mode\":\"collapse\"}');
